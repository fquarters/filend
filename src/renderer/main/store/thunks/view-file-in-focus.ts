...
import { NextIdMessage, ResolvePathMessage, ViewFileMessage } from "../../../../common/ipc/messages";
import { Supplier } from "../../../../common/types";
import { ipcInvoke } from "../../../common/ipc";
import Selectors from "../data/selectors";
import { State } from "../data/state";

const viewFileInFocus = () => async (
    ...
    if (row !== 0) {
        ...
        if (resolvedPath) {
            ...
            ipcInvoke<void, ViewFileMessage>(Message.viewFile({
                id: operationId,
                path: resolvedPath
            }))
        }
...
export default viewFileInFocus